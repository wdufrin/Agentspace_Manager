...
const ShopifyVerification: React.FC = () => {
        ...
        <div className="space-y-6 animate-fadeIn">
            <div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
                    ...
                    <ChecklistItem id="shopify_callback" label="Callback URL" subLabel="https://vertexaisearch.cloud.google.com/oauth-redirect" copyValue="https://vertexaisearch.cloud.google.com/oauth-redirect" />
                </div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <ChecklistItem id="scope_customers" label="read_customers" subLabel="Retrieve customer profiles, contact info, and history." />
                        <ChecklistItem id="scope_orders" label="read_orders" subLabel="View full order details (transactions, items, and status)." />
                        <ChecklistItem id="scope_products" label="read_products" subLabel="View product and product variant information." />
                    </div>
                </div>
            </div>
        </div>
