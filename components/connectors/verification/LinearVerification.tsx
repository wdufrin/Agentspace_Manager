...
const LinearVerification: React.FC = () => {
            ...
            <div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
                    ...
                    <p className="text-gray-400 text-xs mb-4">
                        Linear does not expose granular configuration scopes. Verification relies on Callback URL.
                    </p>
                    <ChecklistItem id="linear_callback" label="Callback URL" subLabel="https://vertexaisearch.cloud.google.com/oauth-redirect" copyValue="https://vertexaisearch.cloud.google.com/oauth-redirect" />
                </div>
            </div>
        </div>
    );
...
export default LinearVerification;
