...
const GitHubVerification: React.FC = () => {
        ...
        <div className="space-y-6 animate-fadeIn">
            <div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
                    ...
                    <ChecklistItem id="oauth_callback" label="Callback URL" subLabel="https://vertexaisearch.cloud.google.com/oauth-redirect" copyValue="https://vertexaisearch.cloud.google.com/oauth-redirect" />
                </div>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                    ...
                    <div className="mb-4">
                        <h5 className="text-xs font-bold text-gray-300 mb-2 uppercase">Repository Permissions</h5>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <ChecklistItem id="repo_contents" label="Repository: Contents" badge="Read-only" />
                            <ChecklistItem id="repo_issues" label="Repository: Issues" badge="Read-only" />
                            <ChecklistItem id="repo_pulls" label="Repository: Pull requests" badge="Read-only" />
                            <ChecklistItem id="repo_metadata" label="Repository: Metadata" badge="Read-only (Mandatory)" />
                        </div>
                    </div>

                    <div className="mb-4">
                        <h5 className="text-xs font-bold text-gray-300 mb-2 uppercase">Organization Permissions</h5>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <ChecklistItem id="org_members" label="Organization: Members" badge="Read-only" />
                            <ChecklistItem id="org_issue_types" label="Organization: Issue Types" badge="Read-only" />
                        </div>
                    </div>

                    <div>
                        <h5 className="text-xs font-bold text-gray-300 mb-2 uppercase">Account Setting Permissions</h5>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <ChecklistItem id="account_profile" label="Account: Profile" badge="Read / Write" />
                        </div>
                    </div>
                </div>
            </div>
