            ...
            <div>
                <h3 className="text-sm font-bold text-gray-300 mb-4 uppercase tracking-wider">
                 ...
                 <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
                    ...
                    <ChecklistItem id="od_tenant" label="Tenant ID" subLabel="Your Microsoft 365 Tenant ID." />
                    <ChecklistItem id="od_client_id" label="Client ID" subLabel="Application (Client) ID from App Registration." />
                    <ChecklistItem id="od_secret" label="Client Secret" subLabel="A valid client secret from Certificates & secrets." />
                </div>
