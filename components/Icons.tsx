...
const IconBase: React.FC<IconProps> = ({ size = 20, className = "", children, ...props }) => (
  <svg
...
export const Hammer: React.FC<IconProps> = (props) => (
  <IconBase {...props}>
    ...
    <path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25V7.86c0-.55-.45-1-1-1H14.5c-.65 0-1.27-.26-1.73-.72l-.04-.04C12.3 5.67 11.7 5.23 11 5.23c-.7 0-1.3.44-1.73 1.13L9 7" />
    <path d="m12 15 2.5-2.5" />
    <path d="m13.41 13.41 1.59 1.59" />
  </IconBase>
);
