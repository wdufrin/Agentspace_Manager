...
const Node: React.FC<NodeProps> = ({ node, isFilteredCenter, isDimmed, onClick, onMouseEnter, onMouseLeave }) => {
    ...
    return (
        <div
            ...
            className={`
                ...
                ${isFilteredCenter ? 'ring-4 ring-yellow-400' : ''}
            `}
            title={node.id}
        >
